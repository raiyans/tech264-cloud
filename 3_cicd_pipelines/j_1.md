...
Before configuring the SSH agent plugin, you need to generate an SSH key pair if you haven't already done so. Follow these steps to generate an SSH key pair on your local machine:
